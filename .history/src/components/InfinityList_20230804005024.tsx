  ...
  return (
    <li className="flex gap-4 border-b px-4 py-4">
      ...
      <div className="flex flex-grow flex-col">
        <div className="flex gap-1 hover:underline focus-visible:underline outline-none">
...
function HeartButton({likedByMe, likeCount}: HeartButtonProps) {
  ...
  return (
    <button className={`group items-center gap-1 self-start flex transition-colors duration-200 ${likedByMe ? "text-red-500" : "text-gray-500 hover:text-red-500 focus-visible:text-red-500"}`}></button>
  )
}
